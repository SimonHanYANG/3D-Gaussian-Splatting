...
class Trainer:
    ...
    def train_step(self, i_iter, bar):
        ...
        # create gaussian splatter for one img
        ...
        if _adaptive_control or _adaptive_control_only_delete:
            ...
            self.gaussian_splatter.gaussian_3ds.adaptive_control(
                ...
                self.accum_max_grad/(torch.tensor(self.grad_counter+1e-3).unsqueeze(dim=-1).to(l1_loss.device)),
    ...
    def train(self):
        ...
        for i_iter in bar:
            ...
            if i_iter == 400:
                # 根据需要动态调整处理图像的分辨率
                # render_downsample in train is 4, in Splatter is 1, so will switch resolution
...
if __name__ == "__main__":
    ...
    # default is 7001
    parser.add_argument("--n_iters", type=int, default=30001)
    ...
    # parser.add_argument("--data", type=str, default="/223010087/SimonWorkspace/3dgs/data/gui/")
    # parser.add_argument("--data", type=str, default="/223010087/SimonWorkspace/3dgs/data/gui_clear/")
   
    # parser.add_argument("--data", type=str, default="/223010087/SimonWorkspace/3dgs/data/a/")
    
    # parser.add_argument("--data", type=str, default="/223010087/SimonWorkspace/3dgs/data/lab")    # no
    # parser.add_argument("--data", type=str, default="/223010087/SimonWorkspace/3dgs/data/gz")   # perform no
    
    # officially
    parser.add_argument("--data", type=str, default="/223010087/SimonWorkspace/3dgs/data/db/playroom/")
    ...
    parser.add_argument("--adaptive_control_end_iter", type=int, default=3000)
